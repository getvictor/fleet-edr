...
- **Detection no longer slows down as you add servers.** Recording what each rule cost set a ceiling on how fast the fleet's events could be processed. That ceiling is gone.

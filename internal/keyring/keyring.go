...
const (
	...
	// are HMAC over the same root.
	ServiceAccountTokenSigningLabel = "edr/service-account/sign/v1" //nolint:gosec // G101: HKDF domain-separation label, not a credential
)

...
- Status: Accepted; narrowing proposed in [0015](0015-clickhouse-visibility-store.md) (the raw `events` archive moves to ClickHouse; MySQL remains the sole RDBMS for the process graph and control plane)
- Date: 2026-05-15
- Deciders: getvictor

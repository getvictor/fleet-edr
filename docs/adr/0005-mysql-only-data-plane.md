...
- Status: Accepted; narrowed by [0015](0015-clickhouse-visibility-store.md) (the raw `events` archive moved from the MySQL `events` table to ClickHouse; MySQL remains the sole RDBMS for the process graph and control plane)
- Date: 2026-05-15
- Deciders: getvictor

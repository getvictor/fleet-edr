...
Update [`docs/adr/README.md`](../../adr/README.md) if any ADR changed status. The index should always be the source of truth for "which ADRs are active".

## Output

- Edits to existing ADRs (status updates, supersession notes).
- Issues filed for ADR gaps.
- Updated [`docs/adr/README.md`](../../adr/README.md).
...
- [ ] [`docs/adr/README.md`](../../adr/README.md) reflects current status.

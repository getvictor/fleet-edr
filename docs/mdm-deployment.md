...
```sh
cd ~/Downloads
curl -fLO https://github.com/getvictor/fleet-edr/releases/download/v0.5.0/fleet-edr-v0.5.0.pkg
curl -fLO https://github.com/getvictor/fleet-edr/releases/download/v0.5.0/edr-system-extension.mobileconfig
curl -fLO https://github.com/getvictor/fleet-edr/releases/download/v0.5.0/edr-tcc-fda.mobileconfig
curl -fLO https://github.com/getvictor/fleet-edr/releases/download/v0.5.0/SHA256SUMS
...
Upload `fleet-edr-<version>.pkg` to your MDM as a software installer and scope to the same Macs. The release tag is part of the filename verbatim (e.g., tag `v0.5.0` ships as `fleet-edr-v0.5.0.pkg`).

...
- **GIVEN** the host page entered for an alert whose alerted process is not present in the fetched process tree
- **WHEN** the operator switches to the timeline view
- **THEN** the timeline lists the full host event stream

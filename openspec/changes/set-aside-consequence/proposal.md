...
- The consequence is selected by the stage, so the builder stage reports a gap in the process graph and the detection stage reports that detection did not complete, so alerts those events would have raised may be missing.

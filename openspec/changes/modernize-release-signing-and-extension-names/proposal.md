...
- Re-signing or relabeling v0.1.1 artifacts: the bundle format cannot be retrofitted onto a published release, so the legacy command stays documented for pre-v0.2.0 tags.

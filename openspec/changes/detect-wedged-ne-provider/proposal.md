...
- The reference window puts a ceiling on how long a wedge stays reported: a fault outlasting 7 days empties it too, and the host stops being flagged. 7 days against the 44-hour incident on record is a 4x margin, and removing the ceiling needs the agent-side change above.

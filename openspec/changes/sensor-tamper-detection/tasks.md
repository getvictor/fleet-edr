...
- [x] `test/efficacy/corpus/T1562.001-sensor-tamper/`: the attack scenario. It PERFORMS Impair Defenses; the rule it exercises claims no technique, because it cannot tell that from a crash.

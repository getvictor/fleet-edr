...
- **THEN** the proxy forwards the query with an OPT record of its own holding a size no larger than the one offered, and no larger than a size that traverses the internet unfragmented

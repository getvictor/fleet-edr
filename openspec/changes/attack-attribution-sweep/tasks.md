...
- [x] 3.12 Stop stating a scenario count in the testing strategy. It was already wrong before this change (8 stated, 12 present) and my correction only fixed the technique list beside it; the runner walks whatever is there, so the number should not be maintained by hand.

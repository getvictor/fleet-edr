...
- [x] 1.6 Report a lost claim only when one was actually lost. A failed return reports not-held because it never got as far as establishing ownership, and warning on that would put a false claim beside a queue outage already logged.

...
import type { EventRecord, HostSummary, NetworkConnectPayload, DNSQueryPayload } from "../../types";
...
function renderEvent(mode: api.EventSearchMode, search: string) {
  return render(
    <MemoryRouter initialEntries={[`/search${search}`]}>
      <EventSearch mode={mode} />
    </MemoryRouter>,
  );
}

...
// "offline" is last_seen at or beyond 5 min old (age >= threshold; a host seen exactly at the cutoff is offline). The agent polls every 5 s, so 5 min is 60x the polling interval: well past any transient network

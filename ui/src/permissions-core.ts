...
export const PermissionAction = {
  ...
  AppControlRuleCreate: "application_control.rule_create",
  AppControlRuleUpdate: "application_control.rule_update",
  AppControlRuleDelete: "application_control.rule_delete",
  AppControlRuleBulkUpsert: "application_control.rule_bulk_upsert",
  ...
  RuleContentWrite: "rule_content.write",

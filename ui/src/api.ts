...
// Enforcement is what a matching rule does: PROTECT blocks the exec, DETECT blocks nothing and keeps a monitor record when it runs.
// The server requires it on every create and bulk-upsert item; it has no default.

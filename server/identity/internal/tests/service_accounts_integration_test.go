...
// spec:server-identity-service-accounts/a-service-account-is-a-non-human-principal-bound-to-a-single-role/service-account-resolves-to-a-service-account-principal-bound-to-one-role

...
// BuildTree returns a forest of process trees for the host + window, plus what the row limit left out (issue #423). flatten opts out
// of sibling aggregation (issue #416).

...
// GetPolicyByID, ListPolicies) so the UI's policies-list view can render "N host groups" without an N+1 round trip. RuleCount is derived the same way and for the same reason. Other

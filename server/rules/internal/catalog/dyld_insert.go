...
// AlgorithmName names the evaluator that decides this rule, for the exported rule file (issue #757). Matches an environment-variable assignment in the leading argv slot, covering both the shell VAR=value form and env(1).

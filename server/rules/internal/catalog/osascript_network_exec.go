...
// AlgorithmName names the evaluator that decides this rule, for the exported rule file (issue #757). Correlates an osascript exec with its
// descendants inside a time window.
